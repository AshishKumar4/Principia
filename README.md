...
An attempt at formalizing foundational physics theorems in Lean 4 using constrained
AI agents.
...
`BLUEPRINT.md` for the dependency DAG of every work item, `PROGRESS.md` for the
dated honest journal, `docs/dossiers/` for design-decision records, and `audits/`
for review evidence.
...
lake build
scripts/check.sh                      # full verification gate (5 gates)
```
